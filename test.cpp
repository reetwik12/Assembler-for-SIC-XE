/*-------------------------------------------------------------------------------------
	To store the OPTAB which is predefined in the assembler
-------------------------------------------------------------------------------------*/
struct instruction
{
	char name[7];
...
instruction OPTAB[]={	{"ADD",0x18,3},{"ADDF",0x58,3},{"ADDR",0x90,2},{"AND",0x40,3},{"CLEAR",0xB4,2},
			...
			{"SUB",0x1C,3},{"SUBR",0x94,2},{"SVC",0xB0,2},{"TD",0xE0,3},{"TIO",0xF8,1},
			{"TIX",0x2C,3},{"TIXR",0xB8,2},{"WD",0xDC,3},{"RESW",0,0},{"RESB",0,0},
 
			{"BYTE",0,0},{"WORD",0,0},{"END",0,0},{"BASE",0,0}
	             };
